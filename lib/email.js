                  ...
                  orderDetails.selectionType === "custom"
                    ? Object.entries(orderDetails.customSelection || {})
                      ...
                      <tr>
                        ...
                        <td>${(orderDetails.drinks.freshOrangeJuice || orderDetails.drinks.verseJus)}x</td>
                        <td>-</td>
                        <td>-</td>
                        <td>-</td>
                        <td>€${((orderDetails.drinks.freshOrangeJuice || orderDetails.drinks.verseJus) * DRINK_PRICES.FRESH_ORANGE_JUICE).toFixed(2)}</td>
                      </tr>
                      ` : "") +
                      ...
                      <tr>
                        ...
                        <td>-</td>
                        <td>-</td>
                        <td>€${(orderDetails.drinks.sodas * DRINK_PRICES.SODAS).toFixed(2)}</td>
                      </tr>
                      ` : "") +
                      ...
                      <tr>
                        ...
                        <td>-</td>
                        <td>-</td>
                        <td>€${(orderDetails.drinks.smoothies * DRINK_PRICES.SMOOTHIES).toFixed(2)}</td>
                      </tr>
                      ` : "") +
                      (orderDetails.drinks?.milk > 0 ? `
                      <tr>
                        <td>Milk</td>
                        <td>${orderDetails.drinks.milk}x</td>
                        <td>-</td>
                        <td>-</td>
                        <td>-</td>
                        <td>€${(orderDetails.drinks.milk * DRINK_PRICES.MILK).toFixed(2)}</td>
                      </tr>
                      ` : "")
                    : `
                      <tr>
