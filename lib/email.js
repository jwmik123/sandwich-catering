...
/**
 * Internal report to the shop (not a customer mail). Recipient defaults to the
 * admin inbox; override with CONSISTENCY_REPORT_EMAIL.
 */
export async function sendAdminReport({ subject, html, text }) {
  const to = process.env.CONSISTENCY_REPORT_EMAIL || EMAIL_CONSTANTS.ADMIN_EMAIL;
