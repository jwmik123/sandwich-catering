...
export class YukiApiClient {
  ...
  formatInvoiceFromOrderData(
    ...
    if (orderData.drinks) {
      if ((orderData.drinks.freshOrangeJuice || orderData.drinks.verseJus) > 0) {
        lines.push({
          description: "Fresh Orange Juice",
          quantity: (orderData.drinks.freshOrangeJuice || orderData.drinks.verseJus),
          unitPrice: DRINK_PRICES.FRESH_ORANGE_JUICE,
          glAccount: "8000", // Sales account
        });
      }
      ...
      if (orderData.drinks.smoothies > 0) {
        lines.push({
          ...
          unitPrice: DRINK_PRICES.SMOOTHIES,
          glAccount: "8000", // Sales account
        });
      }

      if (orderData.drinks.milk > 0) {
        lines.push({
          description: "Milk",
          quantity: orderData.drinks.milk,
          unitPrice: DRINK_PRICES.MILK,
          glAccount: "8000", // Sales account
        });
      }
    }
